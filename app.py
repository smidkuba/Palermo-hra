...
def handle_disconnect():
    ...
    if sid in game_state["players"]:
        ...
        # Pokud odejdou všichni, tvrdý reset serveru
        if len(game_state["players"]) == 0:
            ...
            # Pokud odešel Host, předáme korunu někomu jinému
...
def handle_join(data):
    ...
    # Pokud je vše OK, připojíme hráče
    sid = request.sid
...
def handle_kick(data):
    # KONTROLA 3: Práva administrátora (Hosta)
...
def check_night_end():
    ...
    for sid, act in actions.items():
        if act["role"] == "Blázen" and act["target"] and not act["blocked"]:
            ...
            # (Další fake zprávy pro Blázna zkráceny pro plynulost, logika zůstává)
...
def get_player_info():
    # Vrací seznam slovníků, abychom na frontendu věděli, kdo je Host
